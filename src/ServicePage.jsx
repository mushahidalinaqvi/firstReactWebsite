...
function ServicePage() {
  return (
    <div className="container-fluid mt-5 " style={{height:'600px', width:'80%',justifyContent:'center'}}>
        ...
        <div className="col-md-4"   style={{height:'300px', width :'400px'}}>
          <div className="card mb-4" >
            ...
            <div className="card-body">
              ...
              <a href="#" className="btn btn-warning form-control text-secondry">Learn More</a>
            </div>
          </div>
        </div>
